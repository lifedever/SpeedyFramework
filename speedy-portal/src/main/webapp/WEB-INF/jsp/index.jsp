...
<head>
    ...
    <!-- ========== PAGE TITLE ========== -->
    <title>SoftEase | Software, Mobile App & SaaS HTML template</title>
    <!-- ========== META TAGS ========== -->
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="/static/images/light-logo.svg" alt="SoftEase Logo" class="light-logo">
                <img src="/static/images/dark-logo.svg" alt="SoftEase Logo" class="dark-logo">
            </a> <!-- end navbar-brand -->
                            ...
                            <div class="yamm-content">
                                <div class="nav-col">
                                    <ul>
                                        ...
                                        <li><a href="index-animated-bg.html">Animated Background</a></li>
                                        <li><a href="index-animated-text.html">Animated Text</a></li>
                                        <li><a href="index-simple.html">Animated + Image</a></li>
                    ...
                    <ul class="dropdown-menu animated fadeIn">
                        <li>
                            <div class="yamm-content">
                                ...
                                <div class="nav-col dark-bg text-center">
                                    <h4>Take a demo for FREE!</h4>
                                    <p class="light-text">This is for demo purpose only. </p>
                                    <a href="sign-up.html" class="btn se-btn btn-rounded">SIGN UP</a>
                                </div> <!-- end nav-col -->
                            </div> <!-- end yamm-content -->
                        </li>
                    </ul> <!-- end dropdown-menu -->
                </li> <!-- end dropdown (features) -->
                <li class="">
                    <a href="feature-details.html" class="" >Feature Details </a>
                </li>
                            ...
                            <div class="yamm-content">
                                <div class="nav-col">
                                    <ul>
                                        ...
                                        <li><a href="blog-2.html">Layout 2</a></li>
                                        <li><a href="blog-left-sidebar.html">Left Sidebar</a></li>
                                        <li><a href="blog-2-left-sidebar.html">Left Sidebar 2</a></li>
                                    </ul>
                                </div> <!-- end nav-col -->
                                <div class="nav-col">
                                    <ul>
                                        <li><h5>Single Post</h5></li>
                                        <li><a href="blog-single-post.html">Default</a></li>
                                        <li><a href="blog-single-left-sidebar.html">Left Sidebar</a></li>
                                        <li><a href="blog-single-post-full.html">Full Width</a></li>
                                    </ul>
                                </div> <!-- end nav-col -->
                                <div class="nav-col dark-bg text-center">
                                    <h4>Stay Updated!</h4>
                                    <p class="light-text">Subscribe to our newsletter. </p>
                                    <a href="sign-up.html" class="btn se-btn btn-rounded">SUBSCRIBE</a>
                                </div> <!-- end nav-col -->
                            </div> <!-- end yamm-content -->
                        </li>
                    </ul> <!-- end dropdown-menu -->
                </li> <!-- end dropdown (blog) -->
                <li class="nav-btn-wrap">
                    <span class="nav-btn"><a href="sign-up.html" class="btn se-btn-black btn-rounded">Sign Up</a></span>
                </li>
            </ul> <!-- end navbar-nav -->
...
<!-- ========== HEADER ========== -->
<header class="header main-header parallax-bg" data-parallax="scroll" data-image-src="/static/images/bg-img-3.jpg" data-speed="0.4" >
    <div class="primary-trans-bg">
        <div class="container">
            <!-- For centering the content vertically -->
            <div class="outer">
                <div class="inner text-center">
                    <h1 class="white-color">Create Website That Will Impress Your Customers.</h1>
                    <h5 class="">One of the best HTML templates for Software, Mobile App or SaaS product.</h5>
                    <a href="#" class="btn se-btn-white btn-rounded">Free 30 Days Trial</a>
                </div> <!-- end inner -->
            </div> <!-- end outer -->
        </div> <!-- end container -->
...
<!-- ========== FEATURES ========== -->
<section class="se-section features-section parallax-bg" data-parallax="scroll" data-image-src="/static/images/bg-img-3.jpg" data-speed="0.4">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="/static/images/dark-logo.svg" alt="" class="footer-logo">
            </div>
